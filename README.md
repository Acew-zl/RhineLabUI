...
**当前扩展版本：0.8.1** · [安装与详细说明](docs/EXTENSION.md) · [上游更新评估](docs/UPSTREAM-REVIEW-2026-09-21.md)

![三维书签阵列：顶部书脊显示书签名称，右侧显示文件夹与选中书签](verification/bookmark-readability/overview.png)

*图为 0.8.0 的演示数据预览，图标为占位；0.8.1 已移除文件夹名称右侧的下拉小箭头，使用左右按钮切换。实际安装后读取你自己的书签栏。*
